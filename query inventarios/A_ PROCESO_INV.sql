...
LEFT JOIN (
	...
	WHERE i.`cod_alm` = 2
	AND v.`FECHA` BETWEEN '2019-01-01' AND '2019-03-31'
...
LEFT JOIN (
	...
	WHERE p.`FECHA` BETWEEN '2019-01-01' AND '2019-03-31'
...
LEFT JOIN (
	...
	WHERE d.`cod_alm` = 2
	AND d.`fecha` BETWEEN '2019-01-01' AND '2019-03-31'
...
LEFT JOIN (
	...
	FROM inv_bajas b
	WHERE b.`cod_alm` = 2
	AND b.`fecha` BETWEEN '2019-01-01' AND '2019-03-31'
