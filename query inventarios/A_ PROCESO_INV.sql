...
LEFT JOIN (
	...
	AND v.`FECHA` BETWEEN '2019-01-01' AND '2019-02-08'
...
LEFT JOIN (
	...
	WHERE p.`FECHA` BETWEEN '2019-01-01' AND '2019-02-08'
...
LEFT JOIN (
	...
	AND d.`fecha` BETWEEN '2019-01-01' AND '2019-02-08'
...
LEFT JOIN (
	...
	AND b.`fecha` BETWEEN '2019-01-01' AND '2019-02-08'
...
LEFT JOIN (
	...
	WHERE v.`fecha` BETWEEN '2019-01-01' AND '2019-02-08'
...
UPDATE auxinv i SET i.`costo_prom` = 21.285 WHERE i.`cod_art` = 148; -- EDAM
