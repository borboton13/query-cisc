...
select (@folio := @folio + 1), '2020-10-16' as fecha, 'COMISION BANCO' as descripcion, 'PENDING' as estado, 5.00 as valor, 1 as idcompania, p.`idzonaproductiva`, d.`idproductormateriaprima`, 7 as idtipomovimientoproductor 
...
where p.fechainicio = '2020-10-16'
...
where p.`FECHA_ENTREGA` between '2020-10-16' and '2020-10-31'
