...
select s.`idsocio`, c.idcuenta, t.nombre, s.`nombres`, s.`apellidopaterno`, s.`apellidomaterno`, c.fechaapertura, c.fechavence,  c.`nocuenta`, c.`codigo`, c.`moneda`, 
...
where e.estado <> 'ANL'
and t.tipo = 'DPF'
and c.fechaapertura between '2021-02-01' and '2021-02-28'
